...
# Prompts module (file_loc references removed for open-source)
...
try:
    from config_loader import get_backend_config, get_api_key, get_rate_limit_config, get_paths_config
